...
$ce = [
    'pretitulo'    => null,
    'titulo'       => 'Título da seção extra 01',
...
try { $r = getDbConnection()->query("SELECT * FROM conteudo_extra01 WHERE id = 1")->fetch(); if ($r) $ce = $r; } catch (Exception $e) {}
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
<title>Conteúdo Extra 01 — Admin Animal não é carga</title>
    ...
    <main class="adminLayout__content">
        <section class="adminInicio">
            ...
            <div class="row adminInicio__header">
                <div class="col-md-12">
                    <h2>Conteúdo Extra 01</h2>
                    <p>Seção extra com <strong>texto à esquerda e imagem à direita</strong>. O botão de link é opcional.</p>
                </div>
            </div>
            ...
            <div class="contCard">
                ...
                <div class="contCard__body">
                    <form id="formExtra01" enctype="multipart/form-data">
...
(function () {
    ...
    (function () {
        ...
        function updatePreview(col) {
            ...
            hint.textContent   = 'Texto: col-lg-' + textCol + ' | Imagem: col-lg-' + col;
        }
    ...
    document.getElementById('formExtra01').addEventListener('submit', function (e) {
        e.preventDefault();
